...
Show find-and-replace results on the scrollbar.
...
Requires [find-and-replace](https://web.pulsar-edit.dev/packages/find-and-replace) or [search-panel](https://github.com/asiloisad-pulsar/search-panel).
